    ...
    for e = 1:size(h,2)
        ...
        for i=1:Nq
            ...
            for j=i:Nq
                ...
                l = max(l,0);
                # if e == 1
                #     if h_L_next[i,e] - l*Nq*M_inv[i,i]*(fv1_ES-fv1_i_ID)*dt < 0 || h_L_next[j,e] - l*Nq*M_inv[j,j]*(-fv1_ES-fv1_j_ID)*dt < 0
                #         @show i, j, l, l_ij, l_ji, h[i,e], h[j,e], h_L_next[i,e], h_L_next[j,e]
                #         @show fv1_ES, fv1_i_ID, -fv1_ES, fv1_j_ID
                #         @show h_L_next[i,e] - l*Nq*M_inv[i,i]*(fv1_ES-fv1_i_ID)*dt
                #         @show h_L_next[j,e] - l*Nq*M_inv[j,j]*(-fv1_ES-fv1_j_ID)*dt
                #     end
                # end
                if h[i,e] < tol || h[j,e] < tol || h_L_next[i,e]< tol || h_L_next[j,e]< tol #|| fv1_ES-fv1_i_ID < tol
                    l = 0;
                end
                # if l <0.99 && fv1_ES-fv1_i_ID > tol
                #     @show l_ij, l_ji, h_L_next[i,e],h_L_next[j,e], fv1_ES, fv1_i_ID, fv1_j_ID, M_inv[i,i], M_inv[j,j], dt
                #     error("wrong l")
                # end
