    ...
    for e = 1:size(h,2)
        for i=1:Nq
            ...
            for j=i:Nq
                ...
                if Q_ID[i,j]!=0
                    fv1_i_ID = swe_1d_ID_h(UR_E, Q_ID, i, j, tol, g);
                    fv1_j_ID = swe_1d_ID_h(UL_E, Q_ID, j, i, tol, g);
    ...
    for e = 1:size(h,2)
        ...
        for i=1:Nq
            ...
            for j=i:Nq
                ...
                if Q_ID[i,j]!=0 || i == j
                    fv1_i_ID, fv2_i_ID = swe_1d_ID_vol(UR_E, ops, vgeo, i, j, btm[j,e], tol, g);
                    fv1_j_ID, fv2_j_ID = swe_1d_ID_vol(UL_E, ops, vgeo, j, i, btm[i,e], tol, g);
