...
function swe_1d_esdg_surface(UL, UR, dU, E, nxJ, c, tol, g)::Tuple{Array{Float64,2},Array{Float64,2}}
...
function swe_1d_esdg_vol(UL_E, UR_E, ops, vgeo, i, j, tol, g)
